/*
 * From https://raw.githubusercontent.com/trufflesuite/truffle-hdwallet-provider/master/index.js
 */
...
export function AsureWsWalletProvider(
  mnemonic,
  provider_url,
  address_index = 0,
  num_addresses = 1
  ...
  this.engine.addProvider(
    new ProviderSubprovider(new Web3.providers.WebsocketProvider(provider_url))
  );
...
AsureWsWalletProvider.prototype.sendAsync = function() {
  this.engine.sendAsync.apply(this.engine, arguments);
};

AsureWsWalletProvider.prototype.send = function() {
  return this.engine.send.apply(this.engine, arguments);
};

AsureWsWalletProvider.prototype.on = function() {
  return this.engine.on.apply(this.engine, arguments);
};

AsureWsWalletProvider.prototype.eth_subscribe = function() {
  return this.engine.eth_subscribe.apply(this.engine, arguments);
};

AsureWsWalletProvider.prototype.eth_unsubscribe = function() {
  return this.engine.eth_unsubscribe.apply(this.engine, arguments);
};

// returns the address of the given address_index, first checking the cache
AsureWsWalletProvider.prototype.getAddress = function(idx) {
...
AsureWsWalletProvider.prototype.getAddresses = function() {
