...
class ContractDataExt extends Component {
  static contextTypes = {
  ...
  render() {
    ...
    if (
      !this.props.contracts[this.props.contract] ||
    ...
    if (this.props.format) {
      displayData = this.props.format(displayData);
    }
...
ContractDataExt = drizzleConnect(ContractDataExt, mapStateToProps);

export { ContractDataExt };
